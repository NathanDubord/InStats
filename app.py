...
<<<<<<< HEAD
    ...
    u = requests.get("https://api.instagram.com/v1/users/search?q=" + userinput
                     + "/&access_token=")
    u.text
    ...
    # Get account info
    a = requests.get('https://api.instagram.com/v1/users/' + userid +
                     '/media/recent/?access_token=&count=250')
    r = requests.get('https://api.instagram.com/v1/users/' + userid +
                     '/?access_token=')
    r.text
    a.text
    ...
    for item in htgsfinal:
        try:
            t = requests.get(
                'https://api.instagram.com/v1/tags/' + item +
...
def chart():
    ...
    values3 = [moncount, tuecount, wedcount, thucount, fricount, satcount,
               suncount]
    labels4 = ['0:00',
               '1:00',
               '2:00',
    ...
    return render_template('chart.html',
                           ...
                           values2=values2,
                           labels2=labels2,
                           max_heightJS=max_heightJS,
                           max_height2JS=max_height2JS,
                           ratio=ratio,
                           values3=values3,
                           labels3=labels3,
                           values4=values4,
                           ...
                           values5=values5,
                           labels5=labels5,
                           hashtagerrormsg=hashtagerrormsg,
                           zeroerrormsg=zeroerrormsg,
